  ...
  return (
    <main className="flex flex-col">
      ...
      <div className="fixed bottom-6 right-6 flex flex-col gap-3 z-50">
        <a href="https://wa.me/yournumber" className="bg-green-500 text-white p-3 rounded-full shadow-lg hover:scale-110 transition-transform">
        ...
        <a href="https://m.me/yourpage" className="bg-blue-600 text-white p-3 rounded-full shadow-lg hover:scale-110 transition-transform">
          <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24"><path d="M12 0C5.373 0 0 4.974 0 11.111c0 3.498 1.744 6.614 4.469 8.654V24l4.088-2.242c1.092.304 2.246.464 3.443.464 6.627 0 12-4.974 12-11.111C24 4.974 18.627 0 12 0zm1.291 14.193l-3.077-3.282-5.998 3.282 6.591-7.001 3.167 3.282 5.908-3.282-6.591 7.001z"/></svg>
        </a>
      </div>
        ...
        <div className="flex items-center gap-2">
          {isSale ? (
            <>
              ...
              <span className="text-muted-foreground line-through text-xs">Tk {product.price}</span>
            </>
          ) : (
            <span className="text-primary font-bold">Tk {product.price}</span>
          )}
        </div>
      </div>
    </div>
